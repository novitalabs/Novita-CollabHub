# Novita Agent Runtime - LangGraph Example

**Build AI agents with LangGraph and deploy to Novita Agent Runtime in minutes.**

This example shows you how to quickly deploy an AI agent with streaming responses, multi-turn conversations, and tool integration to Novita Agent Runtime.
...
cd Novita-CollabHub/examples/agent-runtime/agentic-frameworks/langgraph
```
...
|----------|-------------|----------|------------------|
| `NOVITA_API_KEY` | Your Novita AI API Key | ✅ Yes | [Novita API Keys](https://novita.ai/settings/key-management) |
...
3. Verify installation: `pip list | grep novita-sandbox`
